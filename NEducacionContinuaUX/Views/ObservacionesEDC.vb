Public Class ObservacionesEDC
    ...
    Private Sub ObservacionesEDC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ob.tabObservacionesCancelacion(cbTipoObsCancelacion, GridObservacionCancelacion)
        btnEditarObCancelacion.Enabled = False
    End Sub

    Private Sub btnGuardarCondonaciones_Click(sender As Object, e As EventArgs) Handles btnGuardarObCancelacion.Click
    ...
    Private Sub btnSalir_Click(sender As Object, e As EventArgs) Handles btnSalirObCancelacion.Click
        Me.Close()
    End Sub
    ...
    Private Sub btnEditarObCancelacion_Click(sender As Object, e As EventArgs) Handles btnEditarObCancelacion.Click
        Dim activo As Integer
        If (chbActivoCancelacion.Checked = True) Then
            activo = 1
        Else
    ...
    Private Sub txtMatricula_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtObservacionCancelacion.KeyPress
